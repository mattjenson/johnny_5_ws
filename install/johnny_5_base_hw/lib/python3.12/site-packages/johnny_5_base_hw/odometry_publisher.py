...
# Try to import tf_transformations, fall back to manual quaternion calculation
try:
    import tf_transformations
    TF_AVAILABLE = True
except ImportError:
    TF_AVAILABLE = False
    print("tf_transformations not available - using manual quaternion calculation")


def euler_to_quaternion(roll, pitch, yaw):
    """
    Convert Euler angles to quaternion (manual implementation)
    """
...
class OdometryPublisher(Node):
    ...
    def publish_odometry(self):
        ...
        if TF_AVAILABLE:
            ...
            quat = euler_to_quaternion(0, 0, self.theta)
