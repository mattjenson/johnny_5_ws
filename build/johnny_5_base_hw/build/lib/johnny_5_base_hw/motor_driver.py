...
class PololuVNH5019:
    ...
    def __init__(self, logger=None):
        ...
        if not GPIO_AVAILABLE and self.logger:
            self.logger.warn("Running in GPIO simulation mode - no hardware control")
...
class MotorDriverNode(Node):
    ...
    def __init__(self):
        ...
        self.motor_driver = PololuVNH5019(logger=self.get_logger())
